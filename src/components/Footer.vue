...
<div class="row text-dark">
      <div class="col d-block d-flex mt-0">
        ...
        <div class="svg m-3">
          <a
            href="https://instagram.com/i.amntokozo?igshid=YzAwZjE1ZTI0Zg=="
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="svg m-3">
          <a
            href="https://www.facebook.com/ntokozo.sithebe.520?mibextid=ZbWKwL"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
   ...
   /></svg></a>
        ...
        <p>
          We love GOOD SKIN <br />
          <span class="text-white"> DON'T YOU ?</span>
        </p>
        <div>
          <form action="https://formspree.io/f/mnqenpjw" method="post">
            <label>
              <input
                class="text p-3 rounded-pill"
                type="text"
                placeholder="Lets connect"
              />
              <button
                class="rounded-pill m-3 p-2"
                type="submit"
                @click="register"
              >
                Register
